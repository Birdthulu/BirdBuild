...
HOOK @ $806B586C
{
	...
	stw r5, 0xC(r25)		# /
	lis r3, 0x805A			# \
	li r4, 0x28				# | Play SFX 28 (Fighter Common 47)
	lis r12, 0x806A			# |
	ori r12, r12, 0x83F4	# |
	mtctr r12				# |
	bctrl					# /	
...
PrepareToStrikeStage:	
	...
	beq- dontRestrike		# /
	lis r3, 0x805A			# \
	li r4, 0x1FAD			# | Play SFX 1FAD (Shine/Item Grab) X Press
	lis r12, 0x806A			# |
	ori r12, r12, 0x83F4	# |
	mtctr r12				# |
	bctrl					# /
...
StrikeAllOffInStageSwitch:	
	...
	bne 0x1C 				# / 
	lis r3, 0x805A			# \
	li r4, 0x28				# | Play SFX 28 (Fighter Common 47) Y Press
	lis r12, 0x806A			# |
	ori r12, r12, 0x83F4	# |
	mtctr r12				# |
	bctrl					# /	
...
needToClear:
	lis r3, 0x805A			# \
	#li r4, 0x1FAD			# | Play SFX 1FAD (Menu 42) Z Press
	lis r12, 0x806A			# |
	ori r12, r12, 0x83F4	# |
	mtctr r12				# |
	bctrl					# /		
